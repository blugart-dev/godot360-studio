...
| Animate a camera or prepare interactive events | [Authoring](../addons/godot360/AUTHORING.md) · [Skeletal camera timing](skeletal-capture.md) · [Particle capture](particle-capture.md) |
...
| Check glow, exposure and other scene effects | [Renderers](../addons/godot360/RENDERERS.md) · [Capture borders](capture-borders.md) · [Consistent exposure](exposure-consistency.md) |

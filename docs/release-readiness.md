...
1. Complete the [bounded combined-effects milestone](next-session.md#starting-the-next-engineering-task):
   saved lightmaps, a moving probe receiver, lit intersecting transparency and
   persistent compositor history, with a camera cut and independent controls.

...
TESTS = """audio_checks.gd audio_delivery_checks.py audio_formats_review.py
...
studio_checks.gd timeline_checks.gd timeline_studio_checks.gd storage_checks.gd storage_failure_checks.gd release_workflow_checks.gd usability_checks.gd platform_checks.gd renderer_checks.gd renderer_review.py json_lock_review.py package_review.py playback_checks.gd recent_exports_checks.gd""".split()

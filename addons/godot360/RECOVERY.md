...
The panel inspects its last saved job when it starts. Use **Open saved job…** for
any other export folder. This keeps the current recipe and audio controls; it
